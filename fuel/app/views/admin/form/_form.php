	...
	<fieldset>
		<div class="form-group">
			<?php echo Form::label('Subject', 'subject', array('class'=>'control-label')); ?>
				...
				<?php echo Form::input('subject', Input::post('subject', isset($form) ? $form->subject : ''), array('class' => 'col-md-4 form-control', 'placeholder'=>'Subject')); ?>
		...
		<div class="form-group">
			<?php echo Form::label('Tel', 'tel', array('class'=>'control-label')); ?>
				...
				<?php echo Form::input('tel', Input::post('tel', isset($form) ? $form->tel : ''), array('class' => 'col-md-4 form-control', 'placeholder'=>'Tel')); ?>
